...
class dbFactory {
	...
	public function recordUpdate( $ids, $datas, $table, $extra = array(), $file = '' ){
		...
		// save and insert record
		//echo "UPDATE $table SET ".$attributes." WHERE ".$conditions;
		mysql_query("UPDATE $table SET ".$attributes." WHERE ".$conditions) or die(mysql_error());
		//echo "UPDATE $table SET ".$attributes." WHERE ".$conditions;
		//echo "<hr/>";
				// set flag
		if(mysql_affected_rows() > 0)
	...
	// delete record
	public function recordDelete( $idval = array(), $table){
	...
	public function recordInsert_whole( $datas, $table, $exist = '', $extra = array(), $files = array() ){
		// refine args
		$fieldArr = array();
		$dataArr = array();
		...
		// save and insert record
		//echo "INSERT INTO $table (`".$attributes."`) VALUES(".$$datas.")";
		//echo "INSERT INTO $table (".$attributes.") VALUES (".$$datas.")";echo "<hr/>";
		$cn=mysql_query("INSERT INTO $table (".$attributes.") VALUES (".$$datas.")") or die(mysql_error());

...
if(!empty($_SESSION['travell']['Quote']))
{
	$_SESSION['travell']['Step1'] = $_SESSION['travell']['Quote'];
	unset($_SESSION['travell']['Quote']);	
	unset($_SESSION['travell']['Step1']['created_date']);	
}
...
if(isset($_POST['submit_step1']))
{
	...
	$_SESSION['travell']['Step1'] = $_POST;	
	
	$_SESSION['travell']['is_step_2'] = 1;
	
	if(!empty($_SESSION['travell']['Step1']))
	{
		header('Location: '.BASE_URL.'index.php?page=travell-insurance&step=2');	
	}
}
...
if(isset($_POST['submit_step2']))
{
	...
	$_SESSION['travell']['Total_Package_Amount'] = $_POST['package_amt_'.$pkg_no];	
	
	$_SESSION['travell']['Step2']['Package_Amount'] = $_POST['individual_package_amt_'.$pkg_no];
	
	$_SESSION['travell']['Step2']['Additional_Package_Amount'] = $_SESSION['travell']['Total_Package_Amount']-$_SESSION['travell']['Step2']['Package_Amount'];
		
	$_SESSION['travell']['Step2']['package_no'] = $pkg_no;
	$_SESSION['travell']['Step2']['pkg_covers'] = $_POST['pkg_covers_'.$pkg_no];	
	
	//$_SESSION['travell']['Step2'] = $_POST;
	
	unset($_POST);
	
	$_SESSION['travell']['is_step_3'] = 1;
	
	if(!empty($_SESSION['travell']['Step2']))
	{
		header('Location: '.BASE_URL.'index.php?page=travell-insurance&step=3');	
	}
}
...
if(isset($_POST['submit_step3']))
{
	...
	$_SESSION['travell']['Policy']['insured_period_startdate'] = $_POST['insured_period_startdate'];	
		unset($_POST['insured_period_startdate']);	
	
	$_SESSION['travell']['Policy']['insured_period_enddate'] = $_POST['insured_period_enddate'];	
		unset($_POST['insured_period_enddate']);	

	$total_atch = count($_POST['atch_title']); 
	//upload_attachments
	$upload_path = 'upload/travell-attchment/';
	...
	for($i = 0; $i<$total_atch; $i++)
	{
		if($_FILES['atch_file']['name'][$i]!='')
		{
			...
			{
				$no = count($_SESSION['travell']['Attachment']);
				
				$_SESSION['travell']['Attachment'][$no]['atch_title'] = $_POST['atch_title'][$i];
				unset($_POST['atch_title'][$i]);
				
				$_SESSION['travell']['Attachment'][$no]['atch_file'] = $atch_name;
	...
	$_SESSION['travell']['Step3'] = $_POST;	
	
	$_SESSION['travell']['is_step_4'] = 1;
	
	if(!empty($_SESSION['travell']['Step3']))
	{
		header('Location: '.BASE_URL.'index.php?page=travell-insurance&step=4');	
	}
}
...
if(isset($_POST['submit_step4']))
{
	...
	$_SESSION['travell']['is_step_5'] = 1;
	$_SESSION['travell']['Step4'] = $_POST;
	header('Location: '.BASE_URL.'index.php?page=travell-insurance&step=5');	
}

if($step == 1)
{
	$name = 	$_SESSION['travell']['Step1']['name'];
	$occupation = 	$_SESSION['travell']['Step1']['occupation'];
	$iqma_no = 	$_SESSION['travell']['Step1']['iqma_no'];
	$nationality = $_SESSION['travell']['Step1']['nationality'];
	
	if(!empty($_SESSION['travell']['Step1']['dob']))
	{
		$dob = 	date('d-m-Y',strtotime($_SESSION['travell']['Step1']['dob']));
	}
	
	$gender = 	$_SESSION['travell']['Step1']['gender'];
	$network_class = 	$_SESSION['travell']['Step1']['network_class'];
	$chronoc_diseases = 	$_SESSION['travell']['Step1']['chronoc_diseases'];
	
	$total_insured_person = $_SESSION['travell']['Step1']['total_insured_person'];
}

if($step == 2)
{
	$package_no = $_SESSION['travell']['Step2']['package_no'];
	$addtnal_pkg_covers = $_SESSION['travell']['Step2']['pkg_covers'];
	$package_amount = $_SESSION['travell']['Total_Package_Amount'];
}
...
if($step == 3)
{
	...
	if(!empty($_SESSION['travell']['Step3']))
	{
		...
		$title = 	$_SESSION['travell']['Step3']['title'];
		$name = 	$_SESSION['travell']['Step3']['name'];
		$marital_status = $_SESSION['travell']['Step3']['marital_status'];
		$email = 	$_SESSION['travell']['Step3']['email'];
		$phone_mobile = 	$_SESSION['travell']['Step3']['phone_mobile'];
		$country = 	$_SESSION['travell']['Step3']['country'];
		$state = 	$_SESSION['travell']['Step3']['state'];
		$iqma_no = 	$_SESSION['travell']['Step3']['iqma_no'];
		$drive_license_no = 	$_SESSION['travell']['Step3']['drive_license_no'];
		
		if(!empty($_SESSION['travell']['Step3']['dob']))
		{
			$dob = 	date('d-m-Y',strtotime($_SESSION['travell']['Step3']['dob']));
		}
		$gender = 	$_SESSION['travell']['Step3']['gender'];
	}
	
	$attachments = $_SESSION['travell']['Attachment'];
	
	//Policy info
	$insured_period_startdate = $_SESSION['travell']['Policy']['insured_period_startdate'];
	$insured_period_enddate = $_SESSION['travell']['Policy']['insured_period_enddate'];
}
function getPackageDetails($package_no)
{
	$res = mysql_fetch_object(mysql_query("select * from ".TRAVEL_PACKAGE." where package_no='".$package_no."'"));
	return $res;
}

if($step == 4)
{
	if(!empty($_SESSION['travell']['Total_Package_Amount']))
	{
		$package_amount = number_format($_SESSION['travell']['Total_Package_Amount'],2);
	}
	
	$package_no = $_SESSION['travell']['Step2']['package_no'];
	
	//get select package details
	if(!empty($_SESSION['travell']['Step2']['package_no']))
	{
		$pkg = getPackageDetails($_SESSION['travell']['Step2']['package_no']); 
		$pkg_title = stripslashes($pkg->package_title);
		$pkg_desc = stripslashes($pkg->package_desc);
		$pkg_price = number_format($pkg->package_amt,2);
	}

	$accept_terms = $_SESSION['travell']['Step4']['accept_terms'];
	...
	$dob = $_SESSION['travell']['Step3']['dob'];
	...
	$additional_pkg_covers = $_SESSION['travell']['Step2']['pkg_covers'];
...
if($step == 5)
{
	...
	if(isset($_POST['pay_now']))
	{
		...
		include_once("util/travell-pdf.php");
	...
	//check step-5 access
	if($_SESSION['travell']['is_step_5'] != '1')
	{
		header('Location: '.BASE_URL.'index.php?page=travell-insurance&step=1');		
	}
...
<script type="text/javascript" src="js/travel-insurance.js"></script>
            ...
            <div class="auto__ins_head">
                <div class="dataseedin">
                  <div style="float:left; width:222px; height:auto; margin-right:10px;">
                    <h1>Travell Insurance</h1>
                    <div class="clearfix" style="height:7px;"></div>
                    <strong>Travell Insurance</strong>
                  </div>
                  ...
                  <div class="step_area">
                    ...
                    <div class="step1 <?php if($step == 1){echo 'active';}?>" onclick="document.location.href='<?php echo BASE_URL;?>index.php?page=travell-insurance&step=1'">
                      <div style="margin-top:5px;">Find Quote</div>
                    </div>
                    
                    <div class="step2 <?php if($step == 2){echo 'active';}?>" 
                    <?php if(!empty($_SESSION['travell']['is_step_2'])){?>onclick="document.location.href='<?php echo BASE_URL;?>index.php?page=travell-insurance&step=2'"<?php }?>>
                      <div style="margin-top:5px;">Quotation</div>
                    </div>
                    
                    <div class="step3 <?php if($step == 3){echo 'active';}?>" 
                    <?php if(!empty($_SESSION['travell']['is_step_3'])){?>onclick="document.location.href='<?php echo BASE_URL;?>index.php?page=travell-insurance&step=3'"<?php }?>>
                      <div style="margin-top:5px;">Your Details</div>
                    </div>
                    
                    <div class="step4 <?php if($step == 4){echo 'active';}?>" 
                    <?php if(!empty($_SESSION['travell']['is_step_4'])){?>onclick="document.location.href='<?php echo BASE_URL;?>index.php?page=travell-insurance&step=4'"<?php }?>>
                      <div style="margin-top:5px;">Summary</div>
                    </div>
                    
                    <div class="step5 <?php if($step == 5){echo 'active';}?>" 
                    <?php if(!empty($_SESSION['travell']['is_step_5'])){?>onclick="document.location.href='<?php echo BASE_URL;?>index.php?page=travell-insurance&step=5'"<?php }?>>
                 ...
                 <div id="formpan" class="formpan2 formpan5" style="float: left;">
                        ...
                        <input type="hidden" name="policy_class_id" value="1" />
                			...
                			<div class="padding15" style="padding-top:10px;">
                                ...
                                <div class="row1" style="margin-bottom:10px;">
                                    <lable>Is there any existing disability?</lable>
                                    <input type="radio" name="iqma_no" value="1" />Yes
                                    <input type="radio" name="iqma_no" value="2" />No
                                </div>
                                ...
                                <div class="row1">
                                    <lable>Insurance Period</lable>
                                    <select name="nationality" id="nationality" class="dropdown">
                                        <option value="">-Select-</option>
                                        <?php
										$iplist = mysql_query("select * from ".TRAVEL_INSURANCE_PERIOD." where status='1' order by insurance_time asc");
										if(mysql_num_rows($iplist) > 0) 
										{
											while($ip_time = mysql_fetch_array($iplist))
											{
												?>
                                                <option value="<?php echo $ip_time['id'];?>" <?php if($insurance_time == $ip_time['id'])echo 'selected';?>>
													<?php echo stripslashes($ip_time['insurance_time']);?>
                                                </option>
                                                <?php 
											}
										}?>
                                ...
                                <div class="row1">
                                    <lable>Insured Amount</lable>
                                    <select name="insured_amount" id="insured_amount" class="dropdown">
                                        <option value="">-Select-</option>
                                        <?php
										$iamtlist = mysql_query("select * from ".TRAVEL_INSURED_AMOUNT." where status='1' order by insured_amount asc");
										if(mysql_num_rows($iamtlist) > 0) 
										{
											while($ip_amt = mysql_fetch_array($iamtlist))
											{
												?>
                                                <option value="<?php echo $ip_amt['id'];?>" <?php if($insured_amount == $ip_amt['id'])echo 'selected';?>>
													<?php echo stripslashes($ip_amt['insured_amount']);?>
                                                </option>
                                                <?php 
											}
										}?>
                                ...
                                <table style="font-size:11px;" class="insured_person_table" cellspacing="2" cellpadding="2">
                                	<thead>
                                        <tr>
                                            ...
                                            <th width="20%">Is there any existing disability?</th>
                                        </tr>
                                    </thead>
                                    <tbody id="inp_data">
										  <?php
                                          if(isset($total_insured_person))
										  {
											  ...
											  {
												  $inp_name = $_SESSION['travell']['Step1']['inp_name'][$i-1];
												  $inp_gender = $_SESSION['travell']['Step1']['inp_gender'][$i-1];
												  $inp_rel = $_SESSION['travell']['Step1']['inp_rel'][$i-1];
												  $inp_dob = $_SESSION['travell']['Step1']['inp_dob'][$i-1];
												  $inp_occup = $_SESSION['travell']['Step1']['inp_occup'][$i-1];
												  $inp_iqma = $_SESSION['travell']['Step1']['inp_iqma'][$i-1];
												  $inp_chron_ds = $_SESSION['travell']['Step1']['inp_chron_ds'][$i-1];
												  ?>
                                              		<?php
                                                    if($i>1)
													{?>
                                                    ...
                                                    <tr id="insured_person_<?php echo $i;?>">
                                                        ...
                                                        <td>
                                                            <select name="inp_gender[]" id="inp_gender_<?php echo $i;?>">
                                                                <option value="">Select</option>
                                                                <option value="2" <?php if($inp_gender == 2)echo 'selected';?>>Yes</option>
                                                                <option value="1" <?php if($inp_gender == 1)echo 'selected';?>>No</option>
                                                            </select>
					...
					{?>
                    	<form name="step2" id="step2" method="post">
                            ...
                            <?php
							$pckg_sql_qry = mysql_query("select * from ".TRAVEL_PACKAGE." where status='1'");
                    	...
                    	<form name="step4_form" method="post">
                            ...
                            <div>
                                ...
                                <!--<div class="clearfix" style="height:10px;"></div>
                                 ...
                                 <h1 class="newtag1">Travel Information</h1>-->
                                ...
                                <div class="clear" style="height:15px;">&nbsp;</div>
                                <input type="button" class="submit_button" value="Recalculate" name="submit" onclick="document.location.href='<?php echo BASE_URL;?>index.php?page=travell-insurance&step=3'" style="margin-right: 10px;">

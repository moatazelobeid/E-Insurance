...
$country = getElementVal('country',$reg_user_deatil);
                ...
                <div class="rightformpan innerTFl">
                        ...
                        <div class="your-quoatation-inner1">
                          <table width="100%" border="0" cellpadding="2" cellspacing="4">
                                ...
                                <tr>
                                  <td width="345" height="30" style="text-align:left;"><span class="fieldLabelsColumn1"><span class="fieldLabel form_txt1">Name </span></span></td>
                                  <td width="282" height="30"><span class="item dateofbirth"><?php echo $fname;?></span></td>
                                  <td width="32" height="30">&nbsp;</td>
                                  <td width="364" height="30">&nbsp;<span class="fieldLabel form_txt1">Date of Birth </span></td>
                                  <td width="252" height="30"> &nbsp;<span class="item dateofbirth"><?php echo $dob;?></span></td>
                                </tr>
                                <tr>
                                  <td height="30"><span class="fieldLabel1 form_txt1">Gender </span></td>
                                  <td width="282" height="30"><span class="fieldsColumn1"><?php echo $gender;?></span></td>
                                  <td height="30">&nbsp;</td>
                                ...
                                <tr>
                                  ...
                                  <td height="30"><span class="fieldLabel1 form_txt1"><?php echo $country;?></span></td>
                                </tr>
                                <tr>
                                  ...
                                  <td height="30">&nbsp;</td>
                                  <td height="30"><span class="fieldLabel1 form_txt1">Iqama Number</span></td>
								...
								{?>
                                    ...
                                    <tr>
                                      <td width="345" height="30" style="text-align:left;">Vehicle Type</td>
                                      <td width="282" height="30">&nbsp;<span class="item dateofbirth"><?php echo $vtype_title;?></span></td>
                                      <td width="32" height="30">&nbsp;</td>
                                       <td width="364" height="30"><span class="fieldLabel form_txt1">Driver Age </span></td>
                                      <td width="252" height="30"> &nbsp;<span class="item dateofbirth">&nbsp;<?php echo (!empty($policy_details->driver_age))?getDriverAge($policy_details->driver_age):'N/A'; ?></span></td>
                                     <?php /*?> <td width="116" height="30"><span class="fieldLabel form_txt1">Vehicle Cylinder </span></td>
                                      <td width="144" height="30"> &nbsp;<span class="item dateofbirth">&nbsp;<?php echo $vehicle_cylender;?></span></td><?php */?>
                                    </tr>
                                
                                    <tr>
                                      <td width="345" height="30" style="text-align:left;">Driver License Issuing Date</td>
                                       <td width="282" height="30">&nbsp;<span class="item dateofbirth"><?php echo (!empty($policy_details->driver_license_issue_date))?date('d/m/Y',strtotime($policy_details->driver_license_issue_date)):'N/A'; ?></span></td>
                                     <td width="32" height="30">&nbsp;</td>
                                      <td width="364" height="30"><span class="fieldLabel form_txt1">Claim Paid</span></td>
                                      <td width="252" height="30"> &nbsp;<span class="item dateofbirth">&nbsp;<?php echo (!empty($policy_details->vehicle_ncd))?$policy_details->vehicle_ncd:'N/a'; ?></td>
                                    </tr>
                                    ...
                                    <tr>
                                      ...
                                      <td height="30">&nbsp;</td>
                                      <td height="30"><span class="fieldLabel1 form_txt1"> Vehicle Purchase year</span></td>
                                      <td height="30"><span class="fieldLabel1 form_txt1"><?php echo $vehicle_purchase_year;?></span></td>
                                    </tr>
                                ...
                                <?php }
								 ...
								 {?>
                                <tr>
                                  <td width="345" height="30" style="text-align:left;">Driver Age</td>
                                  <td width="282" height="30">&nbsp;<span class="item dateofbirth"><?php echo (!empty($policy_details->driver_age))?getDriverAge($policy_details->driver_age):'N/A'; ?></span></td>
                                  <td width="32" height="30">&nbsp;</td>
                                  <td width="364" height="30"><span class="fieldLabel form_txt1">Driver License Issuing Date</span></td>
                                  <td width="252" height="30"><span class="item dateofbirth"><?php echo (!empty($policy_details->driver_license_issue_date))?date('d/m/Y',strtotime($policy_details->driver_license_issue_date)):'N/A'; ?></span></td>
                                </tr>
                                <tr>
                                  <td width="345" height="30" style="text-align:left;">Vehicle Make</td>
                                  <td width="282" height="30">&nbsp;<span class="item dateofbirth"><?php echo $vmake_title;?></span></td>
                                  <td width="32" height="30">&nbsp;</td>
                                  <td width="364" height="30"><span class="fieldLabel form_txt1">Vehicle Model </span></td>
                                  <td width="252" height="30"> &nbsp;<span class="item dateofbirth">&nbsp;<?php echo $vmodel_title;?></span></td>
                                </tr>
                                <tr>
                                  <td height="30"><span class="fieldLabel1 form_txt1">Vehicle Type </span></td>
                                  <td width="282" height="30"><span class="fieldsColumn1"><?php echo $vtype_title;?></span></td>
                                  <td height="30">&nbsp;</td>
                                ...
                                <tr>
                                  ...
                                  <td height="30">&nbsp;</td>
                                   <td width="364" height="30"><span class="fieldLabel form_txt1">Claim Paid</span></td>
                                      <td width="252" height="30"><?php echo (!empty($policy_details->vehicle_ncd))?$policy_details->vehicle_ncd:'N/a'; ?></td>
                                </tr>
                                ...
                                if(mysql_num_rows($attachment_sql)>0)
                                {
                                    ...
                                    {?>
                                       <tr>
                                          <td width="345" height="30" style="text-align:left;">Document Title</td>
                                          <td width="282" height="30">&nbsp;<span class="item dateofbirth"><?php echo $attachment['atch_title'];?></span></td>
                                          <td width="32" height="30">&nbsp;</td>
                                          <td width="364" height="30"><span class="fieldLabel form_txt1">Attachment</span></td>
                                          <td width="252" height="30"> &nbsp;<span class="item dateofbirth"><?php echo $attachment['atch_file'];?></span></td>
                                        </tr> 
                                <?php }
								}
								else
                                ...
                                <tbody>
                                <tr>
                                  <th height="20" colspan="5" bgcolor="#F0F0F0" class="bluetxt-norm-14" style="padding-left:5px;"><strong>Package Covers</strong></th>
                                </tr>

...
/*	function __construct() {
	...
	//send reset password link
	 	public function admin_reset_password($uid,$uname,$mail="admin@ollyspages.com")
		{
			$email = mailFactory::adminresetpass($mail,$uid,$uname,'Password reset link');
			if($email == '1')
			 {
		...
		public function admin_reset_confm($name,$mail="admin@ollyspages.com")
		{

            ...
            <div id="step-1">
              ...
              <div class="form-row-medical">
                	<select name="driver_age" id="driver_age">
                    	<option value="">&#1593;&#1605;&#1585; &#1575;&#1604;&#1587;&#1575;&#1574;&#1602;</option>
						<?php
                ...
                <div class="form-row-medical">
                	<input id="driver_license_issue_date" name="driver_license_issue_date" placeholder="&#1578;&#1575;&#1585;&#1610;&#1582; &#1575;&#1589;&#1583;&#1575;&#1585; &#1575;&#1604;&#1585;&#1582;&#1589;&#1577;&nbsp;" type="text" onkeypress="return isNumberKey(event)" autocomplete="off" class="date_picker_calender" />
                </div>
                ...
                <div class="form-row-medical">
                	<select name="policy_type_id" id="policy_type_id" onchange="showVehicleColumn(this.value);">
						...
						{?>
                        	<option value="<?php echo $policy_type['id'];?>" <?php if($policy_type['id']==1){?>selected="selected"<?php }?>><?php echo $policy_type['policy_type_ar'];?></option>
                        <?php }
                        ?>
                    </select>
                </div>
                ...
                <div class="form-row-medical vtype_comp" <?php echo $display_comp_clm;?>>
                	<input id="vehicle_made_year" name="vehicle_made_year" placeholder="&#1593;&#1575;&#1605;" type="text" maxlength="4" onkeypress="return isNumberKey(event)" autocomplete="off" onblur="agencyRepair(this.value);" />
                ...
                <div class="form-row-medical vtype_comp" <?php echo $display_comp_clm;?>>
                	<input id="car_value" name="car_value" placeholder="&#1575;&#1604;&#1602;&#1610;&#1605;&#1577; &#1587;&#1610;&#1575;&#1585;&#1577;" type="text" onkeypress="return isNumberKey(event)" autocomplete="off" />
                </div>
                <?php /*?><div class="row1">
              ...
              <div class="row1">
                    <input id="vehicle_ncd" name="vehicle_ncd" placeholder="&#1575;&#1604;&#1578;&#1593;&#1608;&#1610;&#1590;&#1575;&#1578; &#1575;&#1604;&#1605;&#1583;&#1601;&#1608;&#1593;&#1577;" type="text" onkeypress="return isNumberKey(event)" autocomplete="off" />
                </div>
              ...
              <div class="form-row-medical">
                	<input id="mobile_no" name="mobile_no" placeholder="&#1604;&#1580;&#1608;&#1575;&#1604;" maxlength="12" type="text" onkeypress="return isNumberKey(event)" autocomplete="off" />
                </div>

...
<?php if($_GET['page'] == "menu" || $_GET['page'] == "page" || $_GET['page'] == "view_page" || $_GET['page'] == "faqs" || $_GET['page'] == "downloads" || $_GET['page'] == "manage-banner"){ ?>
	...
	<?php /*?><a href="account.php?page=manage-banner"><li <?php if($_GET['page'] == "manage-banner") echo "class='active'"; ?>>Manage Banner</li></a><?php */?>
	</ul>
<?php } ?>

<?php if($_GET['page'] == "package" || $_GET['page'] == "package_list"){ ?>
	<span style="float:left;" class="while18">Underwritting</span></div>
	<div class="clear" style="height:10px;"></div>
	<ul class="dash_left_sec">
	<a href="account.php?page=package"><li <?php if($_GET['page'] == "package") echo "class='active'"; ?>>Add New Underwritting</li></a>
	<a href="account.php?page=package_list"><li <?php if($_GET['page'] == "package_list") echo "class='active'"; ?> style="height:26px;">View/Manage Underwritting</li></a>
	</ul>
<?php } ?>
...
<?php if($_GET['page'] == "config" || $_GET['page'] == "motor-insurance-settings"){ ?>
	...
	<a href="account.php?page=motor-insurance-settings"><li <?php if($_GET['page'] == "motor-insurance-settings") echo "class='active'"; ?>>Motor Insurance Settings</li></a>
	<a href="#"><li>Admin Menu Settings</li></a>
	<a href="#"><li>Access Control</li></a>
	</ul>
<?php } ?>

<?php if($_GET['page'] == "branches" || $_GET['page'] == "business-type" || $_GET['page'] == "doc-type" || $_GET['page'] == "vehicle" || $_GET['page'] == "agency-repair-category" || $_GET['page'] == "deductable-packages" || $_GET['page'] == "driver" || $_GET['page'] == "offices" || $_GET['page'] == "policies"){ ?>
	...
	<?php /*?><a href="account.php?page=branches"><li <?php if($_GET['page'] == "branches") echo "class='active'"; ?>>Branches</li></a>
	...
	<a href="account.php?page=doc-type"><li <?php if($_GET['page'] == "doc-type") echo "class='active'"; ?>>Document Types</li></a><?php */?>
    <a href="account.php?page=agency-repair-category"><li <?php if($_GET['page'] == "agency-repair-category") echo "class='active'"; ?>> Agency Repair Category</li></a>
	<a href="account.php?page=vehicle"><li <?php if($_GET['page'] == "vehicle") echo "class='active'"; ?>>Vehicle</li></a>
    <a href="account.php?page=driver"><li <?php if($_GET['page'] == "driver") echo "class='active'"; ?>>Driver</li></a>
    <a href="account.php?page=deductable-packages"><li <?php if($_GET['page'] == "deductable-packages") echo "class='active'"; ?>>Deductable Packages</li></a>
	</ul>
<?php } ?>

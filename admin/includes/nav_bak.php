  ...
  <ul id="MenuBar1" class="MenuBarHorizontal MenuBarActive">
    <li><a href="account.php" class=""><i class="fa fa-home"></i>Dashboard</a></li>   
        ...
        <ul class="">
					...
					<li><a href="account.php?page=manage-banner">Manage Banner</a></li>
    
                	<?php /*?><li><a href="#">News Feeds </a></li><?php */?>
       	  </ul>
    </li> 
        
		<li><a href="#" class="MenuBarItemSubmenu"><i class="fa fa-sitemap"></i>Packages</a>    
				<ul>
							<li><a href="account.php?page=package">Add New Package</a></li>
							<li><a href="account.php?page=package_list">View/Manage Packages</a></li>
				  </ul>
			</li> 
        ...
        <ul>
    	        	...
    	        	<li><a href="account.php?page=policy-quotes-request">Manage All Quotes</a></li>
	...
	<li><a href="#" class="MenuBarItemSubmenu"><i class="fa fa-tasks"></i>Master</a>    
        <ul class="">
    	        	...
    	        	<li><a href="account.php?page=branches">Branches</a></li>
    				<li><a href="account.php?page=offices">Offices</a></li>
                	<li><a href="account.php?page=business-type">Business Types</a></li>
					<li><a href="account.php?page=doc-type">Document Types</a></li>
   	                <li><a href="account.php?page=vehicle">Veichles</a></li>
      </ul>
    </li>  

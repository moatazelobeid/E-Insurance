...
if($_REQUEST['task']=='delete')
{
 ...
 ?>
	...
	window.location="account.php?page=admin-menu-add";
	</script>
<?php
}
  ...
  <tr>
    <td style="padding-right: 5px;" valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0" height="18" bgcolor="#f2f2f2">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
        ...
        <tr>
        <td width="33%" height="42">Menu Name:</td>
        <td width="67%">
      ...
      <tr>
        ...
        <td width="33%" style="padding-left: 0px;">Set Status:</td>
		...
		?>
          <tr <?php echo $bgcolor; ?>>
           ...
           <!-- <td align="center" ><a id="fancy" href="public/faq_ans.php?id=<?php //echo $row['rid']; ?>"><img src="images/view_all.png" width="87" height="15" border="0"></a></td>-->
			...
			if($row["status"]=='0') { ?>
              <a href="account.php?page=admin-menu-add&task=active&manage=list&id=<?php echo $row["menu_id"]; ?>">In Active</a>
              <?php } else {
				  if($row['menu_id']!='1')
				 { ?>
              
              <a href="account.php?page=admin-menu-add&task=block&manage=list&id=<?php echo $row["menu_id"]; ?>">Active
                  
                  </a>
            <?php }else{?><font color="#528A8D" style="font-size:11px;">Active</font>
                  
                  <?php }} ?></td>
            <td align="center" >
             <?php if($row['menu_id']!='1')
				 { ?>
            <a href="account.php?page=admin-menu-add&task=edit&id=<?php echo $row["menu_id"];  ?>"><img src="images/edit.gif" alt="Edit" width="16" height="16" border="0" title="Edit" style="cursor: pointer;"></a>&nbsp;
           
            <a href="account.php?page=admin-menu-add&task=delete&manage=list&id=<?php echo $row["menu_id"];  ?>" onclick="return confirm('ARE YOU SURE TO DELETE!');"><img src="images/delete.png" alt="Delete" width="16" height="16" border="0" title="Delete" style="cursor: pointer;"></a><?php }?></td>
          </tr>
          <?php $i=$i+1;} ?>
          <tr>

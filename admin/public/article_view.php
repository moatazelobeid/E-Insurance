...
$sql="select * from ".ARTICLETBL." where id='$id'";
...
$smalltext       = stripslashes($row->smalltext);
$smalltext_ar    = stripslashes($row->smalltext_ar);
...
<tr>
  ...
  <td width="22%" align="right" valign="top"><span style="color:#2A1FAA;font-weight:bold">Small Text (En):</span></td>

  <td align="left" ><span style="color:#336699;"><?php echo $smalltext; ?></span></td>
  ...
  <td width="25%" align="right" valign="top"><span style="color:#2A1FAA;font-weight:bold">Small Text (Ar):</span></td>

  <td align="left" ><span style="color:#336699;"><?php echo $smalltext_ar; ?></span></td>

  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="3">
	  ...
	  <td width="3%" align="center"><input type="checkbox" name="chkAll" id="chkAll" onClick="check_all();" /></td>
       ...
       <td width="10%" style="padding-left: 5px;"><strong>Package No </strong></td>
       ...
       <td width="10%" align="center" style="padding-left: 5px;"><strong>Broker</strong></td>
       <td width="9%" align="center" style="padding-left: 5px;"><strong>Agent</strong></td>
      ...
      <tr <?php echo $bgcolor; ?>>
		...
		<td align="center"  style="padding-left: 5px;"><?php echo $row["broker_id"]; ?></td>
		<td align="center"  style="padding-left: 5px;"><?php echo $row["salesman_id"]; ?></td>
        ...
        <td width="6%" align="center"><span style="border-bottom: 0px ; padding-bottom: 0px; padding-left: 1px; padding-right: 1px; font-size: 14px; color: #036;">
		...
		<a href="account.php?page=edit-policy&action=edit&policy_no=<?php echo $row["policy_no"]; ?>&step=1">

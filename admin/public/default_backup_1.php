...
$companies=mysql_num_rows(mysql_query("select * from ".COMPANYTBL.""));
$auto_policy=mysql_num_rows(mysql_query("select * from ".AUTOPOLICY." where del_status='0'"));
...
$policy=$auto_policy+$health_policy+$malpractice_policy+$travel_policy;
$active_auto_policy=mysql_num_rows(mysql_query("select * from ".AUTOPOLICY." where status='1' and del_status='0'"));
...
$active_policy=$active_auto_policy+$active_health_policy+$active_malpractice_policy+$active_travel_policy;
$inactive_auto_policy=mysql_num_rows(mysql_query("select * from ".AUTOPOLICY." where status='0' and del_status='0'"));
...
$inactive_policy=$inactive_auto_policy+$inactive_health_policy+$inactive_malpractice_policy+$inactive_travel_policy;
